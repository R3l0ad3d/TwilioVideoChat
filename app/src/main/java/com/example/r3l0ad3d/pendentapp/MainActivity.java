...
import com.example.r3l0ad3d.pendentapp.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
     ...
     */
    private static String ROOM_NAME = "JOY";
    private static String ACCESS_TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..YamNRCYJaq9KO6yUh1w5_Os7qGUdJOg8yc2LzgtFmZg";
    ...
    private androidx.appcompat.app.AlertDialog connectDialog;
    ...
    private void setAccessToken() {
        firestore.collection("Rooms").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
                ...
                for(DocumentChange dc:queryDocumentSnapshots.getDocumentChanges()){
                    switch (dc.getType()){
                        case ADDED:
                                ...
                                if(ds.contains("roomName")){
                                    ROOM_NAME=ds.getString("roomName");
                                    getAccessToken();
                                }
                                break;
                        case REMOVED:
    ...
    private void getAccessToken() {
        token.getToken("Test Identity",ROOM_NAME)
    ...
    private void connectToRoom(String roomName) {
        configureAudio(true);
        ConnectOptions.Builder connectOptionsBuilder = new ConnectOptions.Builder(ACCESS_TOKEN)
                .roomName(roomName);
